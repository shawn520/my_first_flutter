...
class Group extends DataClass implements Insertable<Group> {
  ...
  @override
  int get hashCode =>
      Object.hash(id, name, parentId, iconCode, createdAt, updatedAt);
  @override
...
final class $$GroupsTableReferences
  ...
  static MultiTypedResultKey<$EntriesTable, List<Entry>> _entriesRefsTable(
    ...
    db.entries,
    aliasName: $_aliasNameGenerator(db.groups.id, db.entries.groupId),
  );
...
class $$GroupsTableTableManager
    extends
        RootTableManager<
          ...
          Group,
          PrefetchHooks Function({bool parentId, bool entriesRefs})
        > {
    ...
    : super(
        TableManagerState(
          ...
          withReferenceMapper: (p0) => p0
              ...
              .toList(),
          prefetchHooksCallback: ({parentId = false, entriesRefs = false}) {
            return PrefetchHooks(
              ...
              getPrefetchedDataCallback: (items) async {
                return [
                  if (entriesRefs)
                    await $_getPrefetchedData<Group, $GroupsTable, Entry>(
                      currentTable: table,
                      referencedTable: $$GroupsTableReferences
                          ._entriesRefsTable(db),
                      managerFromTypedResult: (p0) =>
                          $$GroupsTableReferences(db, table, p0).entriesRefs,
...
final class $$EntriesTableReferences
  ...
  static $GroupsTable _groupIdTable(_$AppDatabase db) => db.groups.createAlias(
    $_aliasNameGenerator(db.entries.groupId, db.groups.id),
  );
